...
**Dashboard — contradictions and ambiguities detected in real time**

![Dashboard](dashboard.png)

**Document comparison — side-by-side excerpts with Copilot analysis**

![Excerpt comparison](excerpt_comparison.png)

**Contradiction detail — Ask Copilot grounded on your tenant**

![Contradiction dialog](dialog_contradiction.png)

**Verdict resolved — full audit trail with resolution comment**

![Resolved dialog](dialog_resolved.png)

**Policy Q&A — Copilot answers grounded on SharePoint documents**

![Copilot Q&A](copilot_question.png)

**Weekly digest — executive summary generated by Copilot**

![Policy digest](policy_digest.png)
